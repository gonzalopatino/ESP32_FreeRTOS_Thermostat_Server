"""
ThermostatRTOS Platform - Django Settings Configuration

This module contains the Django configuration for the ThermostatRTOS
backend platform, including security settings, database configuration,
rate limiting, caching, and Content Security Policy.
